...
import com.example.android.cupboardinventoryapp.R;
...
public class ProductProvider extends ContentProvider {
    ...
    public Cursor query(@NonNull Uri uri, @Nullable String[] projection, @Nullable String selection, @Nullable String[] selectionArgs, @Nullable String sortOrder) {
        ...
        switch (match) {
            case PRODUCTS:
                // Cursor could contain multiple rows of the products table.
    ...
    public Uri insert(@NonNull Uri uri, @Nullable ContentValues contentValues) {
        ...
        switch (match) {
            ...
            default:
                throw new IllegalArgumentException(getContext().getString(R.string.insertion_no_supported) + uri);
        }
    }
    ...
    private Uri insertProduct(Uri uri, ContentValues values) {
        ...
        if (name == null) {
            throw new IllegalArgumentException(getContext().getString(R.string.name_requiered));
        }
        Integer quantity = values.getAsInteger(ProductEntry.COLUMN_PRODUCT_QUANTITY);
        if (quantity == null) {
            throw new IllegalArgumentException(getContext().getString(R.string.quantity_required));
        }
        ...
        if (image == null) {
            throw new IllegalArgumentException(getContext().getString(R.string.image_required));
        }
    ...
    public int delete(@NonNull Uri uri, @Nullable String selection, @Nullable String[] selectionArgs) {
        ...
        switch (match) {
            ...
            case PRODUCT_ID:
                ...
                break;
            default:
                throw new IllegalArgumentException(getContext().getString(R.string.deletion_no_supported) + uri);
        }
        if (rowsDeleted != 0) {
            //Notify all listeners that the data has changed
            getContext().getContentResolver().notifyChange(uri, null);
    ...
    public int update(@NonNull Uri uri, @Nullable ContentValues contentValues, @Nullable String selection, @Nullable String[] selectionArgs) {
        ...
        switch (match) {
            case PRODUCTS:
                //Updating all the products at the inventary
                return updateProduct(uri, contentValues, selection, selectionArgs);
            case PRODUCT_ID:
                //Updating a single product given an id
                selection = ProductEntry._ID + "=?";
                selectionArgs = new String[]{String.valueOf(ContentUris.parseId(uri))};
                return updateProduct(uri, contentValues, selection, selectionArgs);
            default:
                throw new IllegalArgumentException(getContext().getString(R.string.updating_no_supported) + uri);
        }
    }
